...
export const loreApi = {
  ...
  update: (id: string | number, data: Partial<Pick<Lore, "title" | "content">>): Promise<Lore> =>
...
export const charactersApi = {
  ...
  getById: (id: string | number): Promise<Character> => fetchApi(`/characters/${id}`),
  create: (data: Pick<Character, "name" | "bio">): Promise<Character> =>
    fetchApi("/characters", { method: "POST", body: JSON.stringify(data) }),
  update: (id: string | number, data: Partial<Pick<Character, "name" | "bio">>): Promise<Character> =>
    fetchApi(`/characters/${id}`, { method: "PATCH", body: JSON.stringify(data) }),
  delete: async (id: string | number): Promise<void> => {
